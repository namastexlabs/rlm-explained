                ...
                <div className="p-2.5 flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-1 text-[9px] font-mono text-muted-foreground/70">
                      <span>
                        <span className="text-fuchsia-600 dark:text-fuchsia-400">{(stats.inputTokens / 1000).toFixed(1)}k</span>
                        <span className="mx-0.5">→</span>
                        <span className="text-cyan-600 dark:text-cyan-400">{(stats.outputTokens / 1000).toFixed(1)}k</span>
                      </span>
