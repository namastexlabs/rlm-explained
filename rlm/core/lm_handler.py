...
class LMRequestHandler(StreamRequestHandler):
    ...
    def _handle_single(self, request: LMRequest, handler: "LMHandler") -> LMResponse:
        ...
        model_name = request.model or client.model_name
        usage_summary = UsageSummary(model_usage_summaries={model_name: last_usage})
...
class LMHandler:
    ...
    def stream_completion(
        ...
        """Stream tokens from LLM completion (for main process use)."""
        client = self.get_client(model)
        return client.stream_completion(prompt)
