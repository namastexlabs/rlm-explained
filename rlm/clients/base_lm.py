...
class BaseLM(ABC):
    ...
    def stream_completion(
        ...
        """
        Stream tokens from completion. Default: non-streaming fallback.

        Override in subclasses for real streaming support.
        Yields tokens as they arrive, returns full response at the end.
        """
